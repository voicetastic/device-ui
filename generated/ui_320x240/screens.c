...
void create_screen_boot_screen() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffdfd5), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_arc_color(obj, lv_color_hex(0xffffdfd5), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_label_set_text(obj, "voicetastic.cha-sam.re");
        ...
        }
        {
            ...
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffe08a78), LV_PART_MAIN | LV_STATE_DEFAULT);
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffe08a78), LV_PART_MAIN | LV_STATE_PRESSED);
        ...
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_max_width(obj, 72, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_image_recolor(obj, lv_color_hex(0xffffdfd5), LV_PART_MAIN | LV_STATE_DEFAULT);
                }
                {
                    // NodesButton
                    lv_obj_t *obj = lv_btn_create(parent_obj);
                ...
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xffaafbff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_style_shadow_ofs_y(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_image_recolor_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_image_recolor(obj, lv_color_hex(0xffffdfd5), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_image_recolor(obj, lv_color_hex(0xff9b9bff), LV_PART_MAIN | LV_STATE_PRESSED);
                            lv_obj_set_style_bg_image_recolor_opa(obj, 255, LV_PART_MAIN | LV_STATE_PRESSED);
                            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_PRESSED);
                        }
                        ...
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_set_style_pad_column(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    ...
                                    lv_obj_set_style_align(obj, LV_ALIGN_TOP_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    lv_obj_set_style_shadow_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffd29582), LV_PART_MAIN | LV_STATE_PRESSED);
        ...
        }
        {
            ...
            lv_obj_set_style_max_width(obj, 320, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_style_border_width(obj, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_PRESSED);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffdfd5), LV_PART_MAIN | LV_STATE_PRESSED);
        ...
        }
        {
            ...
            lv_obj_set_style_layout(obj, LV_LAYOUT_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffdfd5), LV_PART_KNOB | LV_STATE_DEFAULT);
                    ...
                    lv_obj_set_style_border_color(obj, lv_color_hex(0xffffdfd5), LV_PART_INDICATOR | LV_STATE_DEFAULT);
                    ...
                    lv_obj_set_style_border_color(obj, lv_color_hex(0xffffdfd5), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_border_width(obj, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
                }
                {
                    lv_obj_t *obj = lv_obj_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_style_pad_left(obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffdfd5), LV_PART_INDICATOR | LV_STATE_CHECKED);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffdfd5), LV_PART_INDICATOR | LV_STATE_PRESSED);
                }
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
                ...
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_shadow_spread(obj, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_line_color(obj, lv_color_hex(0xffffdfd5), LV_PART_MAIN | LV_STATE_DEFAULT);
                        }
                        {
                            lv_obj_t *obj = lv_line_create(parent_obj);
                            static lv_point_precise_t line_points[] = {
                ...
                }
                {
                    ...
                    lv_obj_set_style_radius(obj, 50, LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_set_style_outline_color(obj, lv_color_hex(0xffffdfd5), LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    // DetectorStartLabel
        ...
        }
        {
            ...
            lv_obj_set_style_pad_right(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffdfd5), LV_PART_INDICATOR | LV_STATE_DEFAULT);
...
void create_screen_lock_screen() {
    ...
    add_style_main_screen_style(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_align(obj, LV_ALIGN_TOP_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_color(obj, lv_color_hex(0xffffdfd5), LV_PART_ITEMS | LV_STATE_DEFAULT);
