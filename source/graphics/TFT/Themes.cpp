...
uint32_t themeColor[][2] = {
    ...
    {0xff231f1d, 0xfff0e6e4}, // eHomeButtonBg                 -> surfaceContainerHigh (dark default; primaryContainer light when
                              // pressed/active)
...
void Themes::applyLocalOverrides(void)
{
    ...
    lv_obj_t *no_shadow[] = {
        objects.home_container, objects.msg_popup_panel, objects.msg_restore_panel, objects.alert_panel,
        objects.reboot_button,  objects.progmode_button, objects.shutdown_button,
    };
    ...
    lv_obj_t *btns[] = {
        objects.home_mail_button,     objects.home_nodes_button,     objects.home_time_button,     objects.home_lora_button,
        objects.home_signal_button,   objects.home_bell_button,      objects.home_location_button, objects.home_wlan_button,
        objects.home_ethernet_button, objects.home_bluetooth_button, objects.home_mqtt_button,     objects.home_sd_card_button,
    ...
    if (ui_SettingsTabView) {
        lv_obj_set_style_bg_color(ui_SettingsTabView, lv_color_hex(THEME(eTabViewBg)), LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_t *tbtns = lv_tabview_get_tab_bar(ui_SettingsTabView);
        // Default
        lv_obj_set_style_bg_color(tbtns, lv_color_hex(THEME(eTabButtonDefaultBg)), LV_PART_ITEMS | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_grad_color(tbtns, lv_color_hex(THEME(eTabButtonDefaultBg)), LV_PART_ITEMS | LV_STATE_DEFAULT);
        lv_obj_set_style_text_color(tbtns, lv_color_hex(THEME(eTabButtonDefaultText)), LV_PART_ITEMS | LV_STATE_DEFAULT);
        lv_obj_set_style_border_color(tbtns, lv_color_hex(THEME(eTabButtonDefaultBorder)), LV_PART_ITEMS | LV_STATE_DEFAULT);
        // Checked (active)
        lv_obj_set_style_bg_color(tbtns, lv_color_hex(THEME(eTabButtonActiveBg)), LV_PART_ITEMS | LV_STATE_CHECKED);
        lv_obj_set_style_text_color(tbtns, lv_color_hex(THEME(eTabButtonActiveText)), LV_PART_ITEMS | LV_STATE_CHECKED);
        lv_obj_set_style_border_color(tbtns, lv_color_hex(THEME(eMainButtonBg)), // primary indicator
                                      LV_PART_ITEMS | LV_STATE_CHECKED);
        // Pressed
        lv_obj_set_style_bg_color(tbtns, lv_color_hex(THEME(eTabButtonPressedBg)), LV_PART_ITEMS | LV_STATE_PRESSED);
        lv_obj_set_style_text_color(tbtns, lv_color_hex(THEME(eTabButtonPressedText)), LV_PART_ITEMS | LV_STATE_PRESSED);
    }
    ...
    lv_obj_t *menu_btns[] = {
        ui_GeneralLanguageButton,
        ui_GeneralTimezoneButton,
        ui_GeneralScreenButton,
        ui_GeneralMapsButton,
        ui_GeneralAudioButton,
        ui_RadioBluetoothButton,
        ui_RadioDeviceButton,
        ui_RadioDisplayButton,
        ui_RadioLoRaButton,
        ui_RadioNetworkButton,
        ui_RadioPositionButton,
        ui_RadioPowerButton,
        ui_ModuleCannedMsgButton,
        ui_ModuleSaFButton,
        ui_ModuleTelemetryButton,
        ui_ModuleMQTTButton,
        ui_ModuleRangeTestButton,
        ui_ModuleAudioButton,
        ui_ModuleSerialButton,
        ui_ModuleExtNotificationButton,
        ui_ModuleNeighborInfoButton,
        ui_ModuleAmbientLightingButton,
        ui_ModuleDetectionSensorButton,
        ui_ModuleRemoteHardwareButton,
    };
    ...
    lv_obj_t *popup_panels[] = {
        objects.settings_theme_panel,
        objects.settings_alert_buzzer_panel,
        objects.settings_backup_restore_panel,
        objects.settings_brightness_panel,
        objects.settings_channel_panel,
        objects.settings_device_role_panel,
        objects.settings_input_control_panel,
        objects.settings_language_panel,
        objects.settings_modem_preset_panel,
        objects.settings_modify_channel_panel,
        objects.settings_reboot_panel,
        objects.settings_region_panel,
        objects.settings_reset_panel,
        objects.settings_screen_lock_panel,
        objects.settings_screen_timeout_panel,
        objects.settings_timezone,
        objects.settings_username_panel,
    ...
    lv_obj_t *dropdowns[] = {
        objects.settings_theme_dropdown,
        objects.settings_device_role_dropdown,
        objects.settings_keyboard_input_dropdown,
        objects.settings_language_dropdown,
        objects.settings_modem_preset_dropdown,
        objects.settings_mouse_input_dropdown,
        objects.settings_region_dropdown,
        objects.settings_reset_dropdown,
        objects.settings_ringtone_dropdown,
        objects.settings_backup_restore_dropdown,
        objects.setup_region_dropdown,
        objects.nodes_filter_channel_dropdown,
        objects.nodes_filter_hops_dropdown,
        objects.settings_tzcity,
    ...
    for (lv_obj_t *d : dropdowns) {
        ...
        if (list) {
            ...
            lv_obj_set_style_text_color(list, lv_color_hex(THEME(eChannelButtonText)), LV_PART_SELECTED | LV_STATE_CHECKED);
        }
    }
    ...
    lv_obj_t *ok_btns[] = {
        objects.obj2__ok_button_w,  objects.obj3__ok_button_w,  objects.obj4__ok_button_w,  objects.obj5__ok_button_w,
        objects.obj6__ok_button_w,  objects.obj7__ok_button_w,  objects.obj8__ok_button_w,  objects.obj9__ok_button_w,
        objects.obj10__ok_button_w, objects.obj11__ok_button_w, objects.obj12__ok_button_w, objects.obj13__ok_button_w,
        objects.obj14__ok_button_w, objects.obj15__ok_button_w, objects.obj16__ok_button_w, objects.obj17__ok_button_w,
        objects.obj18__ok_button_w, objects.obj21__ok_button_w, objects.obj27__ok_button_w,
    };
    ...
    lv_obj_t *textareas[] = {
        objects.message_input_area,
        objects.nodes_filter_name_area,
        objects.nodes_hl_name_area,
        ...
        objects.settings_user_long_textarea,
        objects.settings_user_short_textarea,
        objects.settings_wifi_password_textarea,
        objects.settings_wifi_ssid_textarea,
        objects.setup_user_long_textarea,
        objects.setup_user_short_textarea,
    };
    ...
    lv_obj_t *icon_btns[] = {
        objects.keyboard_button_0,
        objects.keyboard_button_1,
        objects.keyboard_button_2,
        objects.keyboard_button_3,
        objects.keyboard_button_4,
        objects.keyboard_button_5,
        objects.keyboard_button_6,
        objects.keyboard_button_7,
        objects.keyboard_button_8,
        objects.keyboard_button_9,
        objects.keyboard_button_10,
        objects.keyboard_button_11,
    ...
    if (objects.settings_modify_trash_button) {
        lv_obj_set_style_bg_color(objects.settings_modify_trash_button, kb_bg, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_image_recolor(objects.settings_modify_trash_button, kb_fg, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_image_recolor_opa(objects.settings_modify_trash_button, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
        lv_obj_set_style_radius(objects.settings_modify_trash_button, LV_RADIUS_CIRCLE, LV_PART_MAIN | LV_STATE_DEFAULT);
        // Pressed → primaryContainer (matches our home-button pressed state).
        lv_obj_set_style_bg_color(objects.settings_modify_trash_button, pressed_bg, LV_PART_MAIN | LV_STATE_PRESSED);
    }
